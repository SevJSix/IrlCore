...
public class ChatGPTPopulatorTest extends BlockPopulator {
    ...
    private static final int VEIN_SIZE = 2; // Size of the ore veins
    private final List<Material> materials = Arrays.asList(Material.IRON_ORE, Material.GOLD_ORE, Material.LAPIS_ORE, Material.COAL_ORE, Material.EMERALD_ORE, Material.QUARTZ_ORE, Material.REDSTONE_ORE);
    ...
    public void populate(World world, Random random, Chunk chunk) {
        ...
        // Generate ore veins randomly across the chunk
        for (int i = 0; i < 10; i++) {
    ...
    private void generateVein(World world, Random random, int x, int y, int z) {
        // Generate an ore vein at the given coordinates
